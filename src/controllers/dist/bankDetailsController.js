...
var bankDetailsController = /** @class */ (function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    user = req.user._id;
                    return [4 /*yield*/, bankDetailsModel_1.BankDetails.findOne({ user: user })];
                case 1:
                    isBankDetails = _b.sent();
    ...
    bankDetailsController.getBankDetails = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, bankDetails;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    bankDetails = _a.sent();
                    return [2 /*return*/, res.status(200).json({ error: false, data: bankDetails })];
            }
        });
    }); };
    return bankDetailsController;
}());
exports["default"] = bankDetailsController;
